...
jvm.WorldMap.prototype = {
  ...
  bindElementEvents: function(){
    ...
    previouscode="";
    //////////////// comment used where click on a country////////////////////////////
...
// change in that code
          if (!clickEvent.isDefaultPrevented()) {
            ...
            element.setSelected(!element.isSelected);
                ...
                map.container.trigger(clickEvent, [previouscode]);
        if ((type === 'region' && map.params.regionsSelectable) || (type === 'marker' && map.params.markersSelectable)) {
...
// change in that code
             ...
             element=type == 'region' ? map.regions[previouscode].element : map.markers[previouscode].element;
...
////////////////////////////////////////////////////////////////////////////
  ...
  setASelected: function(type, keys){
    var i;
    ...
    if (jvm.$.isArray(keys)) {
      for (i = 0; i < keys.length; i++) {
        this[type][keys[i]].element.setASelected(true);
      }
    } else {
      for (i in keys) {
        this[type][i].element.setASelected(!!keys[i]);
      }
    }
  },
