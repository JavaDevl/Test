...
(function($){
    $.fn.wowwindow = function(o) {
        var defaults = {
            ...
            closeButton: '<a class="wowwindow-close" title="close" href="javascript:void(0)">Close</a>',
            wrapHTML: '<div id="wowwindow-inner"></div>',
            beforeHTML: '<div style="background-color: #630f0f; color:#FFFFFF;" class="wowwindow-controlbar">{%close%} <span class="wowwindow-title">{%title%}</span></div>',
            afterHTML: '',
            verticalCenter: true,
        ...
        o = o || {}
        if(o.overlay === false || o.overlay === null) {
            o.overlay = {}
        ...
        return this.each(function(){
            var self = this;
            this.open = false;
            var closeButton = (o.closeButton) ? $(o.closeButton) : $('<span></span>');
            if(o.closeButton) {
            ...
            $(this).click(function(event){
                ...
                if(o.overlay.clickToClose && !$.fn.wowwindow.overLayClickEventSet) {
                    $(document.body).click(function(){
                        if($.fn.wowwindow.overLayClickDefault && $('#wowwindow')[0].self.open) {
                            $(document.body).overlayPlayground('close');
                            self.open = false;
                            $('#wowwindow')[0].self = self;
                        }
                ...
                $('#wowwindow .wowwindow-close').click(function() {
                    if(self.open) {
                        $(document.body).overlayPlayground('close');
                        self.open = false;
                    }
                ...
                function _zoom_and_or_rotate() {
                    ...
                    if(o.rotate) {
                        $('#wowwindow').animate({
                            rotate: minus_or_plus + '=' + (360 * o.rotations) + 'deg'
                            }, {
                            queue: false, 
                            duration: o.speed, 
                            complete: function() {
    ...
    $.wowwindow = {
        close: function() {
            var wowwindow = $('#wowwindow');
            if(wowwindow.length > 0 && wowwindow[0].self.open) {
                $(document.body).overlayPlayground('close');
                $('#wowwindow')[0].self.open = false;
            }
        }
    };
